"""
Reprocess failed transcript files using OpenAI GPT-4o-mini
"""
...
def process_transcript(filename, extraction_prompt):
    """Process a single transcript file with GPT-4o-mini."""
    # Load transcript
...
def main():
    ...
    print("=" * 60)
    print("Reprocessing Failed Files with GPT-4o-mini")
    print("=" * 60)
